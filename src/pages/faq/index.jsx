...
export const Faq = () => {
  ...
  return (
    <View style={Container.container}>
      ...
      <Button title={"faq"} text={"2 - Como remover um pet?"} callback={onPressFaq} />
      <Button title={"faq"} text={"3 - Como adicionar uma vacina?"} callback={onPressFaq} />
      <Button title={"faq"} text={"4 - Como remover uma vacina?"} callback={onPressFaq} />
      <Button title={"faq"} text={"5 - Como localizar uma clinica veterinaria?"} callback={onPressFaq} />
      <Button title={"faq"} text={"6 - Como localizar uma petshop?"} callback={onPressFaq} />
    </View>
  );
}
